  ...
  return (
    <div onClick={onClick} style={{ background: 'white', border: '1px solid #eee', borderRadius: '10px', padding: '1.25rem', cursor: 'pointer', transition: 'transform 0.15s, box-shadow 0.15s' }}
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.75rem' }}>
        <div style={{ width: '52px', height: '52px', borderRadius: '8px', overflow: 'hidden', background: '#e0e0e0', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#888', fontWeight: 'bold', fontSize: '1.3rem', flexShrink: 0 }}>
