  ...
  return (
    <div onClick={onClick}
      ...
      <div style={{ position: 'relative', flexShrink: 0 }}>
        <div style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'var(--accent)', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 'bold', fontSize: '0.8rem', opacity: online ? 1 : 0.5 }}>
          {friend.avatar_url ? <img src={friend.avatar_url} alt={friend.full_name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : initial}
        </div>
      ...
      {!collapsed && (
        <div style={{ minWidth: 0, flex: 1, opacity: online ? 1 : 0.6 }}>
